...
function StartUpAccelerator() {
  useEffect(() => {
    document.title =
      "Start-Up Acceleration | Tomorrow's Tech, Today's Innovation";
  }, []);
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen overflow-hidden bg-cover bg-center relative w-full  bg-[#171b2c]"
