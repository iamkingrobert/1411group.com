...
const CEOQuote = () => {
  return (
    <div className="flex flex-col space-y-5 md:space-y-0 md:flex-row justify-center items-center gap-4 md:mx-[100px] mx-[15px] relative md:-top-[60px] -top-[70px]">
      <div className="bg-green-500 rounded-2xl p-8 md:w-1/2">
        ...
        <p className="text-white mt-4 text-[16px] font-mono">
          We bring the technical knowledge, experience and resourcefulness to
          the table.
        </p>
      ...
      <div className="bg-[#265457] rounded-2xl p-4 md:w-1/2 flex flex-row space-x-4">
        <div>
          <div className="flex flex-row items-center  space-x-2 mt-4">
